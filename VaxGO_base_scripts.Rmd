...
covid_13vax <- readRDS(here("Tables", "degs_covid_vaxhagan.rds"))
...
#Correlation analysis ----
  ...
  df_wide <- df_corr %>%
    ...
    cor_matrix <- cor(df_wide, use = "pairwise.complete.obs", method = str_to_lower("spearman")) 
