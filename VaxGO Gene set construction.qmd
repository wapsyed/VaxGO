...
ggsave(ImmuneGO_top20_barplot, file = here("Figures", "ImmuneGO_Top20_GOs_by_set_size.png"), width = 6, height = 6)
...
#Salvar resultados
write.csv(shared_genes_df_mirror, file = here("Tables", "ImmuneGO_sharedgenes_Fishers_Exact_Test.csv")) #Alterar

```
Flourish Circos plot
```{r}

links = shared_genes_df_mirror %>% 
...
col_fun <- colorRamp2(c(0, 100), c("white", "#DF8F44FF"))
...
heatmap_plot = Heatmap(
  ...
  cell_fun = function(j, i, x, y, width, height, fill) {
    grid.text(sprintf("%.0f", matrix[i, j]), x, y, gp = gpar(fontsize = 10))
  },
  show_row_names = TRUE,
  row_names_side = "left",
