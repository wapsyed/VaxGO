...
#Plot
png(filename = here("Figures","ChordDiagram_Covid19_AllCovid_By_Process_Weeks_Immune_Other.png"),
...
Colors
```{r}
col_immune = c("ADAPTIVE IMMUNE SYSTEM" = "#6f2dbd",
          "B CELL" = "#7b2cbf",
...
VAXSigDB_sharedgenes <- read_csv("Tables/VAXSigDB_sharedgenes.csv")
