...
#Plot
pdf(file = here("Figures","ChordDiagram_Covid19_AllCovid_By_Process_Weeks_Immune_Other.pdf"), 
    width = 20, 
    height = 5)
...
```{r}
#Plot
png(filename = here("Figures","ChordDiagram_Covid19_AllCovid_By_Process_Days_Weeks_Immune_Other.png"),
