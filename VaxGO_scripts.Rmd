...
immune_genes_covid = all_covid_vax_atlas  %>% 
  inner_join(ImmuneGO_genes_general %>% 
...
df_vaccines <- immune_genes_covid_shared_process %>% 
  dplyr::select(Cond1 = condition1, Cond2 = condition2, Shared = n, process) 
...
# Plot
#Plot
png(filename = here("Figures","ChordDiagram_Covid19_AllCovid_By_Process.png"), 
